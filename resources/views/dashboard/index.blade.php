                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    <div class="card card-border-shadow-warning h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                <div class="avatar me-2">
                                    <span class="avatar-initial rounded bg-label-warning"><i class="mdi mdi-account mdi-20px"></i></span>
                                </div>
                                <h4 class="ms-1 mb-0 display-6">{{ $qtUsuarios }}</h4>
                            </div>
                            <p class="mb-0 text-heading">Numero de Usuários<rios></rios></p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-101.111px, 134.444px);">
                                                ...
                                                <a class="dropdown-item waves-effect" href="{{ route('backupsListar', $cliente->id) }}"></i> Backups</a>
                                            </div>
                                        </div>
                                    </td>
                              </tr>
