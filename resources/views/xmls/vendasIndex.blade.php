...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <form  action="{{ route('vendasFiltrar') }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        <div class="form-floating form-floating-outline">
                          <input required class="form-control" type="date" onkeyup="controlaAno(this)" id="dtInc" name="dtInc" placeholder="Início" />
                          <label for="dtInc">Início:</label>
                        </div>
                    </div>
                    <div class="col-md-4 form-group">
                        <div class="form-floating form-floating-outline">
                          <input required class="form-control" "controlaAno(this)" type="date" id="dtFn" name="dtFn" placeholder="Final" />
